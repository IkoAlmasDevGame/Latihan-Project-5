        ...
        <div class="container-fluid">
            ...
            <aside class="collapse navbar-collapse" id="NavbarToggler">
                <ul class="navbar-nav ms-auto mx-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a href="../reservasi/index.php?nama=<?=$_SESSION['nama_pengguna']?>" aria-current="page"
                            class="nav-link hover">
                ...
                <div class="mx-5 px-5 ms-5 ps-5 mb-2 mb-lg-0">
                    <div class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li class="dropdown-item bg-light">
                                <span class="fs-6">
                                    <?php echo "Nama anda : ".ucfirst($_SESSION['nama_pengguna']); ?>
                                </span>
                            </li>
                            <li class="dropdown-item bg-light">
                                <span class="fs-6">
                                    <?php echo "Username : ".ucfirst($_SESSION['username']); ?>
                                </span>
                            </li>
                            <li class="dropdown-item bg-light">
                                <span class="fs-6">
                                    <?php echo "Jabatan : ".ucfirst($_SESSION['user_level']); ?>
                                </span>
                            </li>
                        </ul>
                    </div>
